...
| RFC 6840 | rfc6840_mandatory_algorithm_rules | required | 7 | non_queryable | name_algorithm_set_consistency | name_algorithm_set_consistency |
...
| RFC 9364 | rfc9364_bcp_profile_declared | required | 5 | non_queryable | declared_standards_profile | declared_standards_profile |
...
### RFC 6840 / rfc6840_mandatory_algorithm_rules (non_queryable)

Section 5.11: every algorithm in the DS RRset has a DNSKEY, and the zone is signed with every algorithm in the DNSKEY RRset.
...
Missing dictionary fields: `name_algorithm_set_consistency`
...
### RFC 9364 / rfc9364_bcp_profile_declared (non_queryable)

A deployment declared conformance to the DNSSEC BCP profile that RFC 9364 assembles.
...
Missing dictionary fields: `declared_standards_profile`
