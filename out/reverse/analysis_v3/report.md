...
Generated: 2026-08-18T17:45:37  
Pipeline: openintel-rfc-adoption-matcher 0.1.0  
Observation window: 2009-08-01 to 2026-08-01
...
This run evaluated 1,875,584 OpenINTEL rows across 975 partitions against 30 DNSSEC RFCs (50 indicators); 1,875,584 (100.0% of them) reached a rankable decision. That row count is what survived the DNSSEC record-type prefilter, not the size of the partitions: rows of other record types are excluded before any indicator is evaluated, which is what makes a corpus this size tractable. The observation counts in section 7 are exact aggregates over those rows. The 39 observations carried through sections 6 and 8 are a deterministic *sample*, kept so that every aggregate has a worked reasoning trace behind it -- their number is not a measurement of anything. Every score below is derived from record-level observations and the RFC publication date; nothing here is an assertion that an operator deliberately implemented a specification.
...
- Observation window: 2009-08-01 to 2026-08-01.
- Valid matches: 126; partial: 35; ambiguous: 70; no match: 699.
- Rejected on publication date (impossible timestamps): 45.
- Ranked candidates emitted: 9.
- Review queue: 97 items, 13 of high severity.
- Warnings collected during the run: 38.
...
| Parquet input | basis=reverse sources=afrinic,apnic,arin,lacnic,ripe 2009-03-24..2026-08-01 partitions=975 |
| Output directory | out\reverse\analysis_v3 |
| Parquet engine | duckdb |
| Row limit | none |
| Minimum rankable score | 0 |
| Generated at | 2026-08-18T17:45:37 |
| Pipeline | openintel-rfc-adoption-matcher 0.1.0 |
...
| RFC 6840 | rfc6840_clarified_dnssec_present | ambiguous | - | Indicator rfc6840_clarified_dnssec_present is ambiguous: every field it... |
...
| RFC 9364 | rfc9364_dnssec_deployed | ambiguous | - | Indicator rfc9364_dnssec_deployed is ambiguous: every field it referenc... |
...
39 observations are shown below. These are a deterministic sample of the 1,875,584 rows scanned, not the corpus: the distributions in this section describe the sample and must not be read as corpus proportions. The exact per-RFC corpus counts are in section 7, covering 2009-08-01 to 2026-08-01.

- Distinct domains: 36.
- Distinct zones: 4.
- Observations carrying an algorithm number: 39.
...
| RFC 3110 | 11.25 | 78.75 | 241967 | 0 | 0 | rfc3110_rsasha1_algorithm |
| RFC 4033 | 3.75 | 146.25 | 1875584 | 0 | 0 | rfc4033_base_dnssec_record_present, rfc4033_dnssec_algorithm_present |
| RFC 8624 | 3.375 | 47.25 | 0 | 796344 | 636103 | rfc8624_avoids_deprecated_algorithm, rfc8624_recommended_signing_algori... |
| RFC 4034 | 3 | 117 | 1875584 | 0 | 0 | rfc4034_core_record_present |

## 8. Reasoning Summary

Every one of the 1170 signal-by-RFC evaluations carries a stored reasoning trace: the conditions that passed, the conditions that failed, the fields that were missing, the timestamp verdict and the arithmetic of the score. Non-matches are traced too, because the reason an RFC was *not* selected is as much a result as the reason one was.

| Decision | Traces | Share |
| --- | --- | --- |
| no_match | 699 | 59.7% |
| non_queryable | 195 | 16.7% |
| valid_match | 126 | 10.8% |
| ambiguous | 70 | 6.0% |
| timestamp_invalid | 45 | 3.8% |
| partial_match | 35 | 3.0% |

Verbatim reasoning summaries from this run:

**trace_sig_0007_rfc5933** - RFC 5933, signal `sig_0007`, decision `valid_match`, score 18.0:
...
| RFC 6840 | 2013-02-01 | 2013-02-01 | 2026-08-01 | 0 | 1812615 | 10930 |
...
| RFC 9364 | 2023-02-01 | 2023-02-01 | 2026-08-01 | 0 | 640758 | 10930 |
...
| RFC 6840 | 2013-02 | 4242 | 1038 | 0 |
| RFC 6840 | 2013-03 | 4024 | 1019 | 0 |
| RFC 6840 | 2013-04 | 4088 | 1019 | 0 |
| RFC 6840 | 2013-05 | 4122 | 1053 | 0 |
| RFC 6840 | 2013-06 | 4246 | 1074 | 0 |
| RFC 6840 | 2013-07 | 4379 | 1129 | 0 |
| RFC 6840 | 2013-08 | 4609 | 1174 | 0 |
| RFC 6840 | 2013-09 | 4681 | 1185 | 0 |
| RFC 6840 | 2013-10 | 4768 | 1256 | 0 |
| RFC 6840 | 2013-11 | 4784 | 1320 | 0 |
| RFC 6840 | 2013-12 | 5642 | 1477 | 0 |
| RFC 6840 | 2014-01 | 5867 | 1481 | 0 |
| RFC 6840 | 2014-02 | 6251 | 1533 | 0 |
| RFC 6840 | 2014-03 | 6313 | 1625 | 0 |
| RFC 6840 | 2014-04 | 6517 | 1668 | 0 |
| RFC 6840 | 2014-05 | 6614 | 1737 | 0 |
| RFC 6840 | 2014-06 | 6600 | 1753 | 0 |
| RFC 6840 | 2014-07 | 6684 | 1791 | 0 |
| RFC 6840 | 2014-08 | 6732 | 1823 | 0 |
| RFC 6840 | 2014-09 | 7785 | 1940 | 0 |
| RFC 6840 | 2014-10 | 6114 | 2106 | 0 |
| RFC 6840 | 2014-11 | 6455 | 2470 | 0 |
| RFC 6840 | 2014-12 | 6970 | 2597 | 0 |
| RFC 6840 | 2015-01 | 6906 | 2597 | 0 |
| RFC 6840 | 2015-02 | 6888 | 2597 | 0 |
| RFC 6840 | 2015-03 | 6890 | 2614 | 0 |
| RFC 6840 | 2015-04 | 7838 | 2703 | 0 |
| RFC 6840 | 2015-05 | 7817 | 2639 | 0 |
| RFC 6840 | 2015-06 | 8276 | 2875 | 0 |
| RFC 6840 | 2015-07 | 8466 | 2717 | 0 |
| RFC 6840 | 2015-08 | 8924 | 2919 | 0 |
| RFC 6840 | 2015-09 | 7848 | 2934 | 0 |
| RFC 6840 | 2015-10 | 3059 | 1072 | 0 |
| RFC 6840 | 2015-11 | 3075 | 1072 | 0 |
| RFC 6840 | 2015-12 | 4461 | 1438 | 0 |
| RFC 6840 | 2016-01 | 4442 | 1438 | 0 |
| RFC 6840 | 2016-02 | 4411 | 1438 | 0 |
| RFC 6840 | 2016-04 | 4490 | 1487 | 0 |
| RFC 6840 | 2016-05 | 4487 | 1441 | 0 |
| RFC 6840 | 2016-06 | 4500 | 1441 | 0 |
| RFC 6840 | 2016-07 | 4544 | 1452 | 0 |
| RFC 6840 | 2016-08 | 4559 | 1443 | 0 |
| RFC 6840 | 2016-09 | 4575 | 1443 | 0 |
| RFC 6840 | 2016-10 | 4700 | 1500 | 0 |
| RFC 6840 | 2016-11 | 4752 | 1552 | 0 |
| RFC 6840 | 2016-12 | 7637 | 2506 | 0 |
| RFC 6840 | 2017-01 | 8571 | 2883 | 0 |
| RFC 6840 | 2017-02 | 8867 | 2839 | 0 |
| RFC 6840 | 2017-03 | 8875 | 2834 | 0 |
| RFC 6840 | 2017-04 | 8781 | 2770 | 0 |
| RFC 6840 | 2017-05 | 8801 | 2821 | 0 |
| RFC 6840 | 2017-06 | 8808 | 2821 | 0 |
| RFC 6840 | 2017-07 | 9004 | 2869 | 0 |
| RFC 6840 | 2017-08 | 8996 | 2903 | 0 |
| RFC 6840 | 2017-09 | 10325 | 3045 | 0 |
| RFC 6840 | 2017-10 | 10195 | 3046 | 0 |
| RFC 6840 | 2017-11 | 10199 | 3046 | 0 |
| RFC 6840 | 2017-12 | 10257 | 3046 | 0 |
| RFC 6840 | 2018-01 | 10262 | 3081 | 0 |
| RFC 6840 | 2018-02 | 10309 | 3144 | 0 |
| RFC 6840 | 2018-03 | 10225 | 2963 | 0 |
| RFC 6840 | 2018-04 | 10239 | 2963 | 0 |
| RFC 6840 | 2018-05 | 10169 | 2994 | 0 |
| RFC 6840 | 2018-06 | 11109 | 3023 | 0 |
| RFC 6840 | 2018-07 | 11255 | 3075 | 0 |
| RFC 6840 | 2018-08 | 11265 | 3075 | 0 |
| RFC 6840 | 2018-09 | 11362 | 3086 | 0 |
| RFC 6840 | 2018-10 | 11357 | 3086 | 0 |
| RFC 6840 | 2018-11 | 11675 | 3181 | 0 |
| RFC 6840 | 2018-12 | 12898 | 3572 | 0 |
| RFC 6840 | 2019-01 | 13479 | 3858 | 0 |
| RFC 6840 | 2019-02 | 14673 | 4144 | 0 |
| RFC 6840 | 2019-03 | 14834 | 4245 | 0 |
| RFC 6840 | 2019-04 | 14879 | 4273 | 0 |
| RFC 6840 | 2019-05 | 9433 | 4267 | 0 |
| RFC 6840 | 2019-06 | 10713 | 4769 | 0 |
| RFC 6840 | 2019-07 | 11488 | 5263 | 0 |
| RFC 6840 | 2019-08 | 11514 | 5273 | 0 |
| RFC 6840 | 2019-09 | 11601 | 5428 | 0 |
| RFC 6840 | 2019-10 | 11710 | 5442 | 0 |
| RFC 6840 | 2019-11 | 11737 | 5444 | 0 |
| RFC 6840 | 2019-12 | 11811 | 5450 | 0 |
| RFC 6840 | 2020-01 | 12646 | 6408 | 0 |
| RFC 6840 | 2020-02 | 12728 | 6554 | 0 |
| RFC 6840 | 2020-03 | 12754 | 6578 | 0 |
| RFC 6840 | 2020-04 | 12763 | 6578 | 0 |
| RFC 6840 | 2020-05 | 12870 | 6619 | 0 |
| RFC 6840 | 2020-06 | 13915 | 6885 | 0 |
| RFC 6840 | 2020-07 | 13377 | 6701 | 0 |
| RFC 6840 | 2020-08 | 12837 | 6547 | 0 |
| RFC 6840 | 2020-09 | 12911 | 6554 | 0 |
| RFC 6840 | 2020-10 | 12962 | 6604 | 0 |
| RFC 6840 | 2020-11 | 13114 | 6700 | 0 |
| RFC 6840 | 2020-12 | 13360 | 6853 | 0 |
| RFC 6840 | 2021-02 | 13762 | 6932 | 0 |
| RFC 6840 | 2021-03 | 13824 | 7039 | 0 |
| RFC 6840 | 2021-04 | 14068 | 7208 | 0 |
| RFC 6840 | 2021-05 | 14135 | 7232 | 0 |
| RFC 6840 | 2021-06 | 14110 | 7251 | 0 |
| RFC 6840 | 2021-07 | 14099 | 7279 | 0 |
| RFC 6840 | 2021-08 | 14215 | 7281 | 0 |
| RFC 6840 | 2021-09 | 14392 | 7504 | 0 |
| RFC 6840 | 2021-10 | 14514 | 7601 | 0 |
| RFC 6840 | 2021-11 | 14635 | 7766 | 0 |
| RFC 6840 | 2021-12 | 14860 | 7795 | 0 |
| RFC 6840 | 2022-01 | 15027 | 7874 | 0 |
| RFC 6840 | 2022-02 | 15210 | 7848 | 0 |
| RFC 6840 | 2022-03 | 15371 | 7927 | 0 |
| RFC 6840 | 2022-04 | 15436 | 7978 | 0 |
| RFC 6840 | 2022-05 | 15682 | 8168 | 0 |
| RFC 6840 | 2022-06 | 15962 | 8348 | 0 |
| RFC 6840 | 2022-07 | 16063 | 8528 | 0 |
| RFC 6840 | 2022-08 | 16153 | 8646 | 0 |
| RFC 6840 | 2022-09 | 16255 | 8761 | 0 |
| RFC 6840 | 2022-10 | 16189 | 8776 | 0 |
| RFC 6840 | 2022-11 | 15933 | 8814 | 0 |
| RFC 6840 | 2022-12 | 15992 | 8912 | 0 |
| RFC 6840 | 2023-01 | 16025 | 9031 | 0 |
| RFC 6840 | 2023-02 | 16244 | 9175 | 0 |
| RFC 6840 | 2023-03 | 16345 | 9262 | 0 |
| RFC 6840 | 2023-04 | 16498 | 9468 | 0 |
| RFC 6840 | 2023-05 | 16532 | 9433 | 0 |
| RFC 6840 | 2023-06 | 16647 | 9457 | 0 |
| RFC 6840 | 2023-07 | 16725 | 9512 | 0 |
| RFC 6840 | 2023-08 | 16828 | 9801 | 0 |
| RFC 6840 | 2023-09 | 16987 | 9912 | 0 |
| RFC 6840 | 2023-10 | 17201 | 9525 | 0 |
| RFC 6840 | 2023-11 | 17336 | 9642 | 0 |
| RFC 6840 | 2023-12 | 17315 | 9674 | 0 |
| RFC 6840 | 2024-01 | 17408 | 9831 | 0 |
| RFC 6840 | 2024-02 | 17453 | 9819 | 0 |
| RFC 6840 | 2024-03 | 17483 | 9887 | 0 |
| RFC 6840 | 2024-04 | 17542 | 9532 | 0 |
| RFC 6840 | 2024-05 | 17540 | 9547 | 0 |
| RFC 6840 | 2024-06 | 17721 | 9999 | 0 |
| RFC 6840 | 2024-07 | 17868 | 10311 | 0 |
| RFC 6840 | 2024-08 | 17950 | 10480 | 0 |
| RFC 6840 | 2024-09 | 17900 | 10589 | 0 |
| RFC 6840 | 2024-10 | 18116 | 10826 | 0 |
| RFC 6840 | 2024-11 | 18075 | 10930 | 0 |
| RFC 6840 | 2024-12 | 18245 | 10819 | 0 |
| RFC 6840 | 2025-01 | 11118 | 6142 | 0 |
| RFC 6840 | 2025-02 | 11223 | 6149 | 0 |
| RFC 6840 | 2025-03 | 11333 | 6477 | 0 |
| RFC 6840 | 2025-04 | 11428 | 6773 | 0 |
| RFC 6840 | 2025-05 | 11515 | 6763 | 0 |
| RFC 6840 | 2025-06 | 11553 | 6813 | 0 |
| RFC 6840 | 2025-07 | 11713 | 6835 | 0 |
| RFC 6840 | 2025-08 | 11800 | 6767 | 0 |
| RFC 6840 | 2025-09 | 11837 | 6653 | 0 |
| RFC 6840 | 2025-10 | 12278 | 7127 | 0 |
| RFC 6840 | 2025-11 | 12082 | 7118 | 0 |
| RFC 6840 | 2025-12 | 12224 | 7085 | 0 |
| RFC 6840 | 2026-01 | 12273 | 7304 | 0 |
| RFC 6840 | 2026-02 | 12451 | 7296 | 0 |
| RFC 6840 | 2026-03 | 12702 | 7370 | 0 |
| RFC 6840 | 2026-04 | 12722 | 7397 | 0 |
| RFC 6840 | 2026-05 | 12867 | 7445 | 0 |
| RFC 6840 | 2026-06 | 13057 | 7357 | 0 |
| RFC 6840 | 2026-07 | 13213 | 7410 | 0 |
| RFC 6840 | 2026-08 | 13410 | 7387 | 0 |
...
| RFC 9364 | 2023-02 | 16244 | 9175 | 0 |
| RFC 9364 | 2023-03 | 16345 | 9262 | 0 |
| RFC 9364 | 2023-04 | 16498 | 9468 | 0 |
| RFC 9364 | 2023-05 | 16532 | 9433 | 0 |
| RFC 9364 | 2023-06 | 16647 | 9457 | 0 |
| RFC 9364 | 2023-07 | 16725 | 9512 | 0 |
| RFC 9364 | 2023-08 | 16828 | 9801 | 0 |
| RFC 9364 | 2023-09 | 16987 | 9912 | 0 |
| RFC 9364 | 2023-10 | 17201 | 9525 | 0 |
| RFC 9364 | 2023-11 | 17336 | 9642 | 0 |
| RFC 9364 | 2023-12 | 17315 | 9674 | 0 |
| RFC 9364 | 2024-01 | 17408 | 9831 | 0 |
| RFC 9364 | 2024-02 | 17453 | 9819 | 0 |
| RFC 9364 | 2024-03 | 17483 | 9887 | 0 |
| RFC 9364 | 2024-04 | 17542 | 9532 | 0 |
| RFC 9364 | 2024-05 | 17540 | 9547 | 0 |
| RFC 9364 | 2024-06 | 17721 | 9999 | 0 |
| RFC 9364 | 2024-07 | 17868 | 10311 | 0 |
| RFC 9364 | 2024-08 | 17950 | 10480 | 0 |
| RFC 9364 | 2024-09 | 17900 | 10589 | 0 |
| RFC 9364 | 2024-10 | 18116 | 10826 | 0 |
| RFC 9364 | 2024-11 | 18075 | 10930 | 0 |
| RFC 9364 | 2024-12 | 18245 | 10819 | 0 |
| RFC 9364 | 2025-01 | 11118 | 6142 | 0 |
| RFC 9364 | 2025-02 | 11223 | 6149 | 0 |
| RFC 9364 | 2025-03 | 11333 | 6477 | 0 |
| RFC 9364 | 2025-04 | 11428 | 6773 | 0 |
| RFC 9364 | 2025-05 | 11515 | 6763 | 0 |
| RFC 9364 | 2025-06 | 11553 | 6813 | 0 |
| RFC 9364 | 2025-07 | 11713 | 6835 | 0 |
| RFC 9364 | 2025-08 | 11800 | 6767 | 0 |
| RFC 9364 | 2025-09 | 11837 | 6653 | 0 |
| RFC 9364 | 2025-10 | 12278 | 7127 | 0 |
| RFC 9364 | 2025-11 | 12082 | 7118 | 0 |
| RFC 9364 | 2025-12 | 12224 | 7085 | 0 |
| RFC 9364 | 2026-01 | 12273 | 7304 | 0 |
| RFC 9364 | 2026-02 | 12451 | 7296 | 0 |
| RFC 9364 | 2026-03 | 12702 | 7370 | 0 |
| RFC 9364 | 2026-04 | 12722 | 7397 | 0 |
| RFC 9364 | 2026-05 | 12867 | 7445 | 0 |
| RFC 9364 | 2026-06 | 13057 | 7357 | 0 |
| RFC 9364 | 2026-07 | 13213 | 7410 | 0 |
| RFC 9364 | 2026-08 | 13410 | 7387 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| sig_0001 | RFC 6840 | 2009-08-01 | 2013-02-01 | 0 | rfc6840_clarified_dnssec_present |
| sig_0001 | RFC 8624 | 2009-08-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0001 | RFC 9364 | 2009-08-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0001 | RFC 9905 | 2009-08-01 | 2025-11-01 | 0 | rfc9905_deprecated_sha1_in_delegation |
| sig_0002 | RFC 6840 | 2009-09-01 | 2013-02-01 | 0 | rfc6840_clarified_dnssec_present |
| sig_0002 | RFC 8624 | 2009-09-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0002 | RFC 9364 | 2009-09-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0002 | RFC 9905 | 2009-09-01 | 2025-11-01 | 0 | rfc9905_deprecated_sha1_in_delegation |
| sig_0003 | RFC 6840 | 2011-11-01 | 2013-02-01 | 0 | rfc6840_clarified_dnssec_present |
| sig_0003 | RFC 8624 | 2011-11-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0003 | RFC 9364 | 2011-11-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0003 | RFC 9905 | 2011-11-01 | 2025-11-01 | 0 | rfc9905_deprecated_sha1_in_delegation |
| sig_0004 | RFC 8624 | 2013-02-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0004 | RFC 9364 | 2013-02-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0004 | RFC 9905 | 2013-02-01 | 2025-11-01 | 0 | rfc9905_deprecated_sha1_in_delegation |
| sig_0005 | RFC 8624 | 2013-02-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0005 | RFC 9364 | 2013-02-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0005 | RFC 9906 | 2013-02-01 | 2025-11-01 | 15 | rfc9906_deprecated_ecc_gost_still_published |
| sig_0006 | RFC 8624 | 2015-04-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0006 | RFC 9364 | 2015-04-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0006 | RFC 9906 | 2015-04-01 | 2025-11-01 | 15 | rfc9906_deprecated_ecc_gost_still_published |
| sig_0007 | RFC 8624 | 2015-06-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0007 | RFC 9364 | 2015-06-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0007 | RFC 9906 | 2015-06-01 | 2025-11-01 | 18 | rfc9906_deprecated_ecc_gost_still_published, rfc9906_deprecated_gost_di... |
| sig_0008 | RFC 8624 | 2017-03-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0008 | RFC 9364 | 2017-03-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0009 | RFC 8624 | 2018-07-01 | 2019-06-01 | 3.375 | rfc8624_avoids_deprecated_algorithm, rfc8624_recommended_signing_algori... |
| sig_0009 | RFC 9364 | 2018-07-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0010 | RFC 8624 | 2018-11-01 | 2019-06-01 | 0 | rfc8624_avoids_deprecated_algorithm |
| sig_0010 | RFC 9364 | 2018-11-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0010 | RFC 9905 | 2018-11-01 | 2025-11-01 | 0 | rfc9905_deprecated_sha1_in_delegation |
| sig_0011 | RFC 9364 | 2019-09-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0012 | RFC 9364 | 2019-12-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0012 | RFC 9906 | 2019-12-01 | 2025-11-01 | 0 | rfc9906_deprecated_gost_digest_still_published |
| sig_0013 | RFC 9364 | 2020-04-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0014 | RFC 9364 | 2020-05-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0015 | RFC 9364 | 2020-11-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0016 | RFC 9364 | 2021-02-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0017 | RFC 9364 | 2022-05-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0017 | RFC 9906 | 2022-05-01 | 2025-11-01 | 0 | rfc9906_deprecated_gost_digest_still_published |
| sig_0018 | RFC 9364 | 2022-06-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0019 | RFC 9364 | 2022-11-01 | 2023-02-01 | 0 | rfc9364_dnssec_deployed |
| sig_0019 | RFC 9906 | 2022-11-01 | 2025-11-01 | 0 | rfc9906_deprecated_gost_digest_still_published |
| sig_0021 | RFC 9906 | 2023-06-01 | 2025-11-01 | 0 | rfc9906_deprecated_gost_digest_still_published |
| sig_0023 | RFC 9906 | 2024-03-01 | 2025-11-01 | 0 | rfc9906_deprecated_gost_digest_still_published |
...
| sig_0004 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0004: the required indica... |
...
| sig_0005 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0005: the required indica... |
...
| sig_0006 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0006: the required indica... |
...
| sig_0007 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0007: the required indica... |
...
| sig_0008 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0008: the required indica... |
...
| sig_0009 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0009: the required indica... |
...
| sig_0010 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0010: the required indica... |
...
| sig_0011 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0011: the required indica... |
...
| sig_0012 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0012: the optional indicator rfc5... |
| sig_0012 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0012: the required indica... |
...
| sig_0013 | RFC 8624 | ambiguous | 3.375 | rr_type, validator_algorithm_support | RFC 8624 is an ambiguous match for signal sig_0013: the required indica... |
| sig_0013 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0013: every required... |
| sig_0013 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0013: the required indica... |
...
| sig_0014 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0014: the required indica... |
...
| sig_0015 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0015: the required indica... |
...
| sig_0016 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0016: the required indica... |
...
| sig_0017 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0017: the optional indicator rfc5... |
| sig_0017 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0017: the required indica... |
...
| sig_0018 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0018: the required indica... |
...
| sig_0019 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0019: the optional indicator rfc5... |
| sig_0019 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0019: the required indica... |
...
| sig_0020 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0020: the required indica... |
...
| sig_0020 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0020: the required indica... |
...
| sig_0021 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0021: the optional indicator rfc5... |
| sig_0021 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0021: the required indica... |
...
| sig_0021 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0021: the required indica... |
...
| sig_0022 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0022: the required indica... |
...
| sig_0022 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0022: the required indica... |
...
| sig_0023 | RFC 8624 | ambiguous | 3.375 | rr_type, validator_algorithm_support | RFC 8624 is an ambiguous match for signal sig_0023: the required indica... |
| sig_0023 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0023: every required... |
| sig_0023 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0023: the optional indicator rfc5... |
| sig_0023 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0023: the required indica... |
...
| sig_0023 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0023: the required indica... |
...
| sig_0024 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0024: the required indica... |
...
| sig_0024 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0024: the required indica... |
...
| sig_0025 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0025: the required indica... |
...
| sig_0025 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0025: the required indica... |
...
| sig_0026 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0026: the required indica... |
...
| sig_0026 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0026: the required indica... |
...
| sig_0026 | RFC 9905 | partial_match | 0 | - | RFC 9905 partially matches signal sig_0026: the optional indicator rfc9... |
| sig_0027 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0027: every required... |
| sig_0027 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0027: the required indica... |
...
| sig_0027 | RFC 8624 | partial_match | 0 | rr_type, validator_algorithm_support | RFC 8624 partially matches signal sig_0027: the optional indicator rfc8... |
| sig_0027 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0027: the required indica... |
...
| sig_0028 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0028: the required indica... |
...
| sig_0028 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0028: the required indica... |
...
| sig_0029 | RFC 8624 | ambiguous | 3.375 | rr_type, validator_algorithm_support | RFC 8624 is an ambiguous match for signal sig_0029: the required indica... |
| sig_0029 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0029: every required... |
| sig_0029 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0029: the required indica... |
...
| sig_0029 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0029: the required indica... |
...
| sig_0030 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0030: the required indica... |
...
| sig_0030 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0030: the required indica... |
...
| sig_0031 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0031: the required indica... |
...
| sig_0031 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0031: the required indica... |
...
| sig_0031 | RFC 9905 | partial_match | 0 | - | RFC 9905 partially matches signal sig_0031: the optional indicator rfc9... |
...
| sig_0032 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0032: the optional indicator rfc5... |
| sig_0032 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0032: the required indica... |
...
| sig_0032 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0032: the required indica... |
...
| sig_0032 | RFC 9906 | partial_match | 0 | - | RFC 9906 partially matches signal sig_0032: the optional indicator rfc9... |
| sig_0033 | RFC 8624 | ambiguous | 3.375 | rr_type, validator_algorithm_support | RFC 8624 is an ambiguous match for signal sig_0033: the required indica... |
| sig_0033 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0033: every required... |
| sig_0033 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0033: the required indica... |
...
| sig_0033 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0033: the required indica... |
...
| sig_0034 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0034: the optional indicator rfc5... |
| sig_0034 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0034: the required indica... |
...
| sig_0034 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0034: the required indica... |
...
| sig_0034 | RFC 9906 | partial_match | 0 | - | RFC 9906 partially matches signal sig_0034: the optional indicator rfc9... |
| sig_0035 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0035: every required... |
| sig_0035 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0035: the required indica... |
...
| sig_0035 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0035: the required indica... |
...
| sig_0036 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0036: the required indica... |
...
| sig_0036 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0036: the required indica... |
...
| sig_0036 | RFC 9905 | partial_match | 0 | - | RFC 9905 partially matches signal sig_0036: the optional indicator rfc9... |
| sig_0037 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0037: every required... |
| sig_0037 | RFC 5933 | partial_match | 0 | - | RFC 5933 partially matches signal sig_0037: the optional indicator rfc5... |
| sig_0037 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0037: the required indica... |
...
| sig_0037 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0037: the required indica... |
...
| sig_0037 | RFC 9906 | partial_match | 0 | - | RFC 9906 partially matches signal sig_0037: the optional indicator rfc9... |
| sig_0038 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0038: every required... |
| sig_0038 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0038: the required indica... |
...
| sig_0038 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0038: the required indica... |
...
| sig_0039 | RFC 4035 | non_queryable | 0 | dnssec_ok_flag | RFC 4035 could not be evaluated against signal sig_0039: every required... |
| sig_0039 | RFC 6840 | ambiguous | 0 | - | RFC 6840 is an ambiguous match for signal sig_0039: the required indica... |
| sig_0039 | RFC 7583 | non_queryable | 0 | key_rollover_phase | RFC 7583 could not be evaluated against signal sig_0039: every required... |
| sig_0039 | RFC 8198 | non_queryable | 0 | resolver_synthesised_nxdomain | RFC 8198 could not be evaluated against signal sig_0039: every required... |
...
| sig_0039 | RFC 9364 | ambiguous | 0 | - | RFC 9364 is an ambiguous match for signal sig_0039: the required indica... |
| sig_0039 | RFC 9615 | non_queryable | 0 | domain, rr_type | RFC 9615 could not be evaluated against signal sig_0039: every required... |
| sig_0039 | RFC 9904 | non_queryable | 0 | guidance_source_registry | RFC 9904 could not be evaluated against signal sig_0039: every required... |
| sig_0039 | RFC 9905 | partial_match | 0 | - | RFC 9905 partially matches signal sig_0039: the optional indicator rfc9... |
...
| --- | --- | --- |
| schema_inconsistency | 54 | 55.7% |
| llm_review_recommended | 13 | 13.4% |
| non_queryable_indicator | 6 | 6.2% |
| ambiguous_indicator | 5 | 5.2% |
| timestamp_invalid_match | 5 | 5.2% |
| missing_required_field | 4 | 4.1% |
| partial_match | 4 | 4.1% |
| close_ranking | 3 | 3.1% |
| partially_queryable_indicator | 3 | 3.1% |
...
| rev_0002 | non_queryable_indicator | high | RFC 7583 | Indicator rfc7583_rollover_timing_observed (required, weight 6.0) of RF... | Add `key_rollover_phase` to the OpenINTEL analysis dictionary with an o... |
| rev_0003 | non_queryable_indicator | high | RFC 8198 | Indicator rfc8198_aggressive_nsec_use (required, weight 6.0) of RFC 819... | Add `resolver_synthesised_nxdomain` to the OpenINTEL analysis dictionar... |
| rev_0004 | non_queryable_indicator | high | RFC 8624 | Indicator rfc8624_validator_algorithm_support (optional, weight 6.0) of... | Add `validator_algorithm_support` to the OpenINTEL analysis dictionary... |
| rev_0005 | non_queryable_indicator | high | RFC 9615 | Indicator rfc9615_bootstrap_signal_label (required, weight 10.0) of RFC... | Add `domain` to the OpenINTEL analysis dictionary with an openintel_nat... |
| rev_0006 | non_queryable_indicator | high | RFC 9904 | Indicator rfc9904_algorithm_guidance_process (required, weight 5.0) of... | Add `guidance_source_registry` to the OpenINTEL analysis dictionary wit... |
| rev_0007 | partial_match | high | RFC 5933 | RFC 5933 matched partially on 10 observation(s): indicator(s) rfc5933_g... | Inspect indicator(s) rfc5933_ecc_gost_algorithm against signal(s) sig_0... |
| rev_0008 | partial_match | high | RFC 9906 | RFC 9906 matched partially on 5 observation(s): indicator(s) rfc9906_de... | Inspect indicator(s) rfc9906_deprecated_ecc_gost_still_published agains... |
| rev_0009 | timestamp_invalid_match | high | RFC 3110, RFC 4033, RFC 4034, RFC 4509, RFC 5702, RFC 5933, RFC 6605, R... | 10 observation(s) matched RFC 8624 indicator(s) rfc8624_avoids_deprecat... | Verify the RFC 8624 publication_date 2019-06-01T00:00:00 in the checkli... |
| rev_0010 | timestamp_invalid_match | high | RFC 3110, RFC 4033, RFC 4034, RFC 4509, RFC 5702, RFC 5933, RFC 6605, R... | 19 observation(s) matched RFC 9364 indicator(s) rfc9364_dnssec_deployed... | Verify the RFC 9364 publication_date 2023-02-01T00:00:00 in the checkli... |
| rev_0011 | timestamp_invalid_match | high | RFC 3110, RFC 4033, RFC 4034, RFC 4509, RFC 6840, RFC 9905 | 5 observation(s) matched RFC 9905 indicator(s) rfc9905_deprecated_sha1_... | Verify the RFC 9905 publication_date 2025-11-01T00:00:00 in the checkli... |
| rev_0012 | timestamp_invalid_match | high | RFC 3110, RFC 4033, RFC 4034, RFC 6840 | 3 observation(s) matched RFC 6840 indicator(s) rfc6840_clarified_dnssec... | Verify the RFC 6840 publication_date 2013-02-01T00:00:00 in the checkli... |
| rev_0013 | timestamp_invalid_match | high | RFC 4033, RFC 4034, RFC 5933, RFC 6605, RFC 6840, RFC 8624, RFC 9364, R... | 8 observation(s) matched RFC 9906 indicator(s) rfc9906_deprecated_ecc_g... | Verify the RFC 9906 publication_date 2025-11-01T00:00:00 in the checkli... |
| rev_0014 | ambiguous_indicator | medium | RFC 6605, RFC 8080, RFC 8624 | Indicator rfc8624_avoids_deprecated_algorithm of RFC 8624 is ambiguous... | Decide attribution by hand for signal(s) sig_0011, sig_0012, sig_0013,... |
| rev_0015 | ambiguous_indicator | medium | RFC 6605, RFC 8080, RFC 8624 | Indicator rfc8624_recommended_signing_algorithm of RFC 8624 is ambiguou... | Decide attribution by hand for signal(s) sig_0012, sig_0013, sig_0015,... |
...
| rev_0017 | ambiguous_indicator | medium | RFC 6840 | Indicator rfc6840_clarified_dnssec_present of RFC 6840 is ambiguous (Ba... | Decide attribution by hand for signal(s) sig_0004, sig_0005, sig_0006,... |
| rev_0018 | ambiguous_indicator | medium | RFC 9364 | Indicator rfc9364_dnssec_deployed of RFC 9364 is ambiguous (DNSSEC is d... | Decide attribution by hand for signal(s) sig_0020, sig_0021, sig_0022,... |
| rev_0019 | close_ranking | medium | RFC 4509, RFC 6605 | RFC 6605 (score 13.125) and RFC 4509 (score 11.25) differ by 14.29%, in... | Do not report RFC 6605 as the single best match. Compare the distinguis... |
| rev_0020 | close_ranking | medium | RFC 5702, RFC 6605 | RFC 5702 (score 13.125) and RFC 6605 (score 13.125) differ by 0.0%, ins... | Do not report RFC 5702 as the single best match. Compare the distinguis... |
| rev_0021 | close_ranking | medium | RFC 5933, RFC 8080 | RFC 5933 (score 18.0) and RFC 8080 (score 17.25) differ by 4.17%, insid... | Do not report RFC 5933 as the single best match. Compare the distinguis... |
| rev_0022 | llm_review_recommended | medium | RFC 4033 | The deterministic verifier returned needs_manual_review for 39 trace(s)... | Open trace(s) trace_sig_0001_rfc4033, trace_sig_0002_rfc4033, trace_sig... |
| rev_0023 | llm_review_recommended | medium | RFC 4034 | The deterministic verifier returned needs_manual_review for 39 trace(s)... | Open trace(s) trace_sig_0001_rfc4034, trace_sig_0002_rfc4034, trace_sig... |
| rev_0024 | llm_review_recommended | medium | RFC 4035 | The deterministic verifier returned needs_manual_review for 39 trace(s)... | Open trace(s) trace_sig_0001_rfc4035, trace_sig_0002_rfc4035, trace_sig... |
| rev_0025 | llm_review_recommended | medium | RFC 5933 | The deterministic verifier returned needs_manual_review for 10 trace(s)... | Open trace(s) trace_sig_0012_rfc5933, trace_sig_0017_rfc5933, trace_sig... |

72 further items are in `review_queue.json`.
...
- **Indicators the corpus cannot express.** 6 indicators (rfc4035_dnssec_ok_negotiated, rfc7583_rollover_timing_observed, rfc8198_aggressive_nsec_use, rfc8624_validator_algorithm_support, rfc9615_bootstrap_signal_label, rfc9904_algorithm_guidance_process) reference fields that do not exist in the OpenINTEL dictionary, typically resolver-side behaviour. They are neither confirmed nor refuted here.
...
- Resolve the 38 warning(s) recorded in `run_manifest.json`; each one marks a place where the run degraded rather than failed.
...
- RFC 6781 was published 2012-12-01, but the OpenINTEL fields its indicators rely on only become available later: `flags` (from 2016-01-01). Adoption of RFC 6781 before 2016-01-01 cannot be observed through this corpus, so a first-seen date is a lower bound on when the mechanism appeared, not on when it was adopted.
- Dictionary fields `key_tag` (from 2010-01-01), `measurement_id` (from 2010-01-01), `nsec3_flags` (from 2010-01-01), `rsa_key_bitsize` (from 2010-01-01), `source` (from 2010-01-01), `timestamp` (from 2010-01-01), `tlsa_selector` (from 2012-08-01), `zone` (from 2010-01-01) become available after the earliest RFC in this checklist was published. No indicator references them today, but any future indicator built on them will inherit that lower bound.
- 30725 source-day(s) in the requested range have no objects under out\reverse\corpus; they are absent from this run rather than empty. Ingest or mirror them if the range is meant to be complete.
- Field 'dnskey_protocol' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 4034/rfc4034_dnskey_protocol_is_three); every condition over it compiles to FALSE, so those indicators can never match here.
...
- Field 'flags' has no column in this corpus but is referenced by 2 evaluable indicator(s) (RFC 5011/rfc5011_revoked_key_published, RFC 6781/rfc6781_ksk_zsk_separation); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'nsec3_iterations' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 9276/rfc9276_zero_nsec3_iterations); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'nsec3_salt' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 9276/rfc9276_empty_nsec3_salt); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'record_ttl' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 9077/rfc9077_nsec_ttl_bounded); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'rrsig_type_covered' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 4034/rfc4034_rrsig_type_covered_present); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'tlsa_matchtype' has no column in this corpus but is referenced by 1 evaluable indicator(s) (RFC 6698/rfc6698_tlsa_fields_well_formed); every condition over it compiles to FALSE, so those indicators can never match here.
- Field 'tlsa_usage' has no column in this corpus but is referenced by 2 evaluable indicator(s) (RFC 6698/rfc6698_tlsa_fields_well_formed, RFC 7671/rfc7671_dane_usage_preferred); every condition over it compiles to FALSE, so those indicators can never match here.
- Rows whose rr_type is not one of CDNSKEY, CDS, DNSKEY, DS, NSEC, NSEC3, NSEC3PARAM, RRSIG, TLSA were excluded before any indicator was evaluated. That is what makes the run tractable, and it assumes every DNSSEC observation carries one of those record types; an observation with a null or unexpected rr_type is not counted.
- RFC 6840 has 1812615 ambiguous observation(s) in the corpus aggregates but does not appear among the ranked candidates: no sampled exemplar earned a score above the threshold. The aggregate counts are still exact; only the ranking is exemplar-derived.
- RFC 9364 has 640758 ambiguous observation(s) in the corpus aggregates but does not appear among the ranked candidates: no sampled exemplar earned a score above the threshold. The aggregate counts are still exact; only the ranking is exemplar-derived.
...
- This is an aggregate run over 975 partition(s) and 1875584 scanned row(s). observed_signals.json, rfc_matches.json and reasoning_traces.json hold 39 sampled exemplar observation(s), not the corpus: they exist to show that the aggregate counts in ranked_candidates.json and adoption_timeline.json mean what they say. Do not read their length as a measurement.
